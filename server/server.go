...
func poly_trader_list(c *gin.Context) {
	...
	c.HTML(http.StatusOK, "polymarkets_trader_list.html", gin.H{
		"MarketId" : market_id,
		"ContractAid" : fpmm_aid,
		"Traders" : users_list,
	})
...
func poly_funder_list(c *gin.Context) {

}
func poly_trader_operations(c *gin.Context) {
	...
	c.HTML(http.StatusOK, "polymarkets_trader_operations.html", gin.H{
		"MarketId" : market_id,
		"UserAid" : user_aid,
		"ContractAid" : fpmm_aid,
...
func poly_funder_operations(c *gin.Context) {
