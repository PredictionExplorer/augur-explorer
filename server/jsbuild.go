...
func build_js_randomwalk_withdrawal_chart(intervals* []RW_API_WithdrawalChartEntry) template.JS {
	var data_str string = "["
...
func build_js_floor_price_data(intervals* []RW_API_RWalkFloorPrice) template.JS {
	var data_str string = "["
