...
func set_api_routing_cosmic_game(r *gin.Engine) {
	...
	r.GET("/api/cosmicgame/staking/cst/actions/global/:offset/:limit",api_cosmic_game_staking_cst_actions_global)
	r.GET("/api/cosmicgame/staking/cst/actions/info/:action_id",api_cosmic_game_staking_cst_action_info)
	...
	r.GET("/api/cosmicgame/staking/rwalk/actions/info/:action_id",api_cosmic_game_staking_rwalk_action_info)
