...
func set_api_routing_cosmic_game(r *gin.Engine) {
	...
	r.GET("/api/cosmicgame/user/staked/cst/:user_addr",api_cosmic_game_staked_tokens_cst_by_user)
	r.GET("/api/cosmicgame/user/staked/rwalk/:user_addr",api_cosmic_game_staked_tokens_rwalk_by_user)
	r.GET("/api/cosmicgame/donations/eth/simple/list",api_cosmic_game_donations_eth_simple_list)
	r.GET("/api/cosmicgame/donations/eth/simple/by_round",api_cosmic_game_donations_eth_simple_by_round)
	r.GET("/api/cosmicgame/donations/eth/with_info/list",api_cosmic_game_donations_eth_with_info_list)
	r.GET("/api/cosmicgame/donations/eth/with_info/by_round",api_cosmic_game_donations_eth_with_info_by_round)
	...
	r.GET("/api/cosmicgame/staking/cst/rewards/action_ids_by_deposit_with_claim_info/:user_addr/:deposit_id",api_cosmic_game_staking_cst_rewards_action_ids_by_deposit_with_claim_info)
	...
	r.GET("/api/cosmicgame/staking/cst/rewards/global/:offset/:limit",api_cosmic_game_staking_cst_rewards_global)
