...
func set_api_routing_cosmic_game(r *gin.Engine) {
	...
	r.GET("/api/cosmicgame/user/unclaimed_raffle_deposits/:user_addr/:offset/:limit",api_cosmic_game_unclaimed_prize_deposits_by_user)
	...
	r.GET("/api/cosmicgame/donations/erc20/:round_num",api_cosmic_game_donations_erc20_by_round)
	...
	r.GET("/api/cosmicgame/staking/cst/history/by_user/:user_addr",api_cosmic_game_staking_cst_history_by_user)
	...
	r.GET("/api/cosmicgame/staking/cst/by_user/rewards/:user_addr",api_cosmic_game_staking_cst_by_user_rewards)
