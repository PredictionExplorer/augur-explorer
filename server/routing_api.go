...
func set_api_routing_cosmic_game(r *gin.Engine) {
	...
	r.GET("/api/cosmicgame/staking/rwalk/mints/global",api_cosmic_game_staking_rwalk_mints_global)
	r.GET("/api/cosmicgame/staking/rwalk/mints/by_user",api_cosmic_game_staking_rwalk_mints_by_user)
