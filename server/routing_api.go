...
func set_api_routing_biddingwar(r *gin.Engine) {
	...
	r.GET("/api/cosmicgame/prize/claim_history/:offset/:limit",api_biddingwar_global_claim_history_detail)
	...
	r.GET("/api/cosmicgame/cst/list_by_user/:user_addr/:offset/:limit",api_biddingwar_cosmic_signature_token_list_by_user)
