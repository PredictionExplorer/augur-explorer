...
func set_routing_cosmic_game(r *gin.Engine) {
	...
	r.GET("/black/cosmicgame/prizes/deposits/unclaimed/:user_addr",cosmic_game_unclaimed_prize_deposits_by_user)
	...
	r.GET("/black/cosmicgame/cst/transfers/by/user/:user_addr",cosmic_game_cosmic_signature_transfers_by_user)
	...
	r.GET("/black/cosmicgame/ct/transfers/:user_addr",cosmic_game_cosmic_token_transfers_by_user)
	...
	r.GET("/black/cosmicgame/donations/nft/unclaimed/by_prize/:prize_num",cosmic_game_unclaimed_donated_nfts_by_prize)
	r.GET("/black/cosmicgame/donations/nft/unclaimed/by_user/:user_addr",cosmic_game_unclaimed_donated_nfts_by_user)
	r.GET("/black/cosmicgame/donations/erc20/by_round/:round_num",cosmic_game_donations_erc20_by_round)
	...
	r.GET("/black/cosmicgame/raffle/nft_winnings/by_user/:user_addr",cosmic_game_user_raffle_nft_winnings)
	...
	r.GET("/black/cosmicgame/staking/cst/staked/by_user/:user_addr",cosmic_game_staked_tokens_cst_by_user)
	...
	r.GET("/black/cosmicgame/staking/rwalk/staked/by_user/:user_addr",cosmic_game_staked_tokens_rwalk_by_user)
