...
func set_routing_cosmic_game(r *gin.Engine) {
	...
	r.GET("/black/cosmicgame/prizes/history/global/:offset/:limit",cosmic_game_global_claim_history_detail)
	r.GET("/black/cosmicgame/prizes/history/by_user/:user_addr/:offset/:limit",cosmic_game_claim_history_detail)
