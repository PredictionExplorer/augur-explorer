...
func set_routing_cosmic_game(r *gin.Engine) {
	...
	r.GET("/black/cosmicgame/prizes/deposits/raffle/by_user/:user_addr",cosmic_game_prize_deposits_raffle_eth_by_user)
	r.GET("/black/cosmicgame/prizes/deposits/chrono_warrior/by_user/:user_addr",cosmic_game_prize_deposits_chrono_warrior_by_user)
