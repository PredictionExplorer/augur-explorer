...
func set_routing_cosmic_game(r *gin.Engine) {
	...
	r.GET("/black/cosmicgame/donations/eth/simple/list",cosmic_game_donations_eth_simple_list)
	r.GET("/black/cosmicgame/donations/eth/simple/by_round",cosmic_game_donations_eth_simple_by_round)
	r.GET("/black/cosmicgame/donations/eth/with_info/list",cosmic_game_donations_eth_with_info_list)
	r.GET("/black/cosmicgame/donations/eth/with_info/by_round",cosmic_game_donations_eth_with_info_by_round)
