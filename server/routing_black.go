...
func set_routing_biddingwar(r *gin.Engine) {
	...
	r.GET("/black/cosmicgame/prize/claim_history/:offset/:limit",biddingwar_global_claim_history_detail)
	...
	r.GET("/black/cosmicgame/cst/list_by_user/:user_addr",biddingwar_cosmic_signature_token_list_by_user)
	...
	r.GET("/black/cosmicgame/user/unclaimed_raffle_deposits/:user_addr",biddingwar_unclaimed_raffle_deposits_by_user)
	...
	r.GET("/black/cosmicgame/donations/nft/unclaimed_by_prize/:prize_num",biddingwar_unclaimed_donated_nfts_by_prize)
