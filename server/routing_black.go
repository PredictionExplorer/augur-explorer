...
func set_routing_cosmic_game(r *gin.Engine) {
	...
	r.GET("/black/cosmicgame/prizes/eth/all/global",cosmic_game_all_eth_deposits_list)
	r.GET("/black/cosmicgame/prizes/eth/all/global/:offset/:limit",cosmic_game_all_eth_deposits_list)
	r.GET("/black/cosmicgame/prizes/eth/raffle/global",cosmic_game_raffle_eth_deposits_list)
	r.GET("/black/cosmicgame/prizes/eth/raffle/global/:offset/:limit",cosmic_game_raffle_eth_deposits_list)
	r.GET("/black/cosmicgame/prizes/eth/chronowarrior/global",cosmic_game_chronowarrior_eth_deposits_list)
	r.GET("/black/cosmicgame/prizes/eth/chronowarrior/global/:offset/:limit",cosmic_game_chronowarrior_eth_deposits_list)
	r.GET("/black/cosmicgame/prizes/eth/all/by_user/:user_addr",cosmic_game_unified_eth_all_by_user)
	r.GET("/black/cosmicgame/prizes/eth/raffle/by_user/:user_addr",cosmic_game_unified_eth_raffle_by_user)
	r.GET("/black/cosmicgame/prizes/eth/chronowarrior/by_user/:user_addr",cosmic_game_unified_eth_chronowarrior_by_user)
	r.GET("/black/cosmicgame/prizes/eth/unclaimed/by_user/:user_addr",cosmic_game_unclaimed_prize_deposits_by_user)
	...
	r.GET("/black/cosmicgame/prizes/deposits/unclaimed/by_user/:user_addr",cosmic_game_unclaimed_prize_deposits_by_user)
	...
	r.GET("/black/cosmicgame/raffle/deposits/list",cosmic_game_prize_deposits_list)
	...
	r.GET("/black/cosmicgame/eth_deposits/all/list/:offset/:limit",cosmic_game_all_eth_deposits_list)
	r.GET("/black/cosmicgame/eth_deposits/raffle_eth/list/:offset/:limit",cosmic_game_raffle_eth_deposits_list)
	r.GET("/black/cosmicgame/eth_deposits/chronowarrior_eth/list/:offset/:limit",cosmic_game_chronowarrior_eth_deposits_list)
