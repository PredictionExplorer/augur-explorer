...
func set_routing_cosmic_game(r *gin.Engine) {
	...
	r.GET("/black/cosmicgame/user/raffle_deposits/:user_addr",cosmic_game_prize_deposits_by_user)
	r.GET("/black/cosmicgame/user/unclaimed_raffle_deposits/:user_addr",cosmic_game_unclaimed_prize_deposits_by_user)
	...
	r.GET("/black/cosmicgame/user/unique_donors",cosmic_game_unique_donors)
	r.GET("/black/cosmicgame/user/unique_stakers_cst",cosmic_game_unique_stakers_cst)
	r.GET("/black/cosmicgame/user/unique_stakers_rwalk",cosmic_game_unique_stakers_rwalk)
	r.GET("/black/cosmicgame/user/unique_stakers_both",cosmic_game_unique_stakers_both)
	...
	r.GET("/black/cosmicgame/user/staked/cst/:user_addr",cosmic_game_staked_tokens_cst_by_user)
	r.GET("/black/cosmicgame/user/staked/rwalk/:user_addr",cosmic_game_staked_tokens_rwalk_by_user)
	...
	r.GET("/black/cosmicgame/donations/erc20/:round_num",cosmic_game_donations_erc20_by_round)
	...
	r.GET("/black/cosmicgame/staking/cst/rewards/action_ids_by_deposit_with_claim_info/:user_addr/:deposit_id",cosmic_game_staking_cst_rewards_action_ids_by_deposit_with_claim_info)
	...
	r.GET("/black/cosmicgame/staking/cst/staked_tokens",cosmic_game_staked_tokens_cst_global)
	...
	r.GET("/black/cosmicgame/staking/cst/by_user/by_token/rewards/:user_addr",cosmic_game_staking_cst_by_user_by_token_rewards)
	r.GET("/black/cosmicgame/staking/cst/by_user/by_token/rewards/details/:user_addr/:token_id",cosmic_game_staking_cst_by_user_by_token_rewards_details)
	r.GET("/black/cosmicgame/staking/cst/by_user/by_deposit/rewards/:user_addr",cosmic_game_staking_cst_by_user_by_deposit_rewards)
	...
	r.GET("/black/cosmicgame/staking/rwalk/staked_tokens",cosmic_game_staked_tokens_rwalk_global)
