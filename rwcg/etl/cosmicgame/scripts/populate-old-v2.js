/**
 * populate-old-v2.js — sample chain population for Cosmic-Signature v2 branch.
 *
 * Flow: deploy CosmicSignatureGame (V1 proxy) → run rounds on V1 APIs → upgrade
 * to CosmicSignatureGameV2 with initializeV2() → continue (V2 BidPlaced + admin events).
 *
 * V2-branch renames even on the V1 contract:
 *   setCstRewardAmountForBidding → setBidCstRewardAmount
 * After upgrade:
 *   setBidCstRewardAmountMultiplier, setCstDutchAuctionDuration,
...
async function deferRoundActivationForUpgrade() {
    ...
    console.log(`Deferred round activation to ${futureActivation} for V2 upgrade`);
}
