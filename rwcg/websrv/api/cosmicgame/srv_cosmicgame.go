...
func cosmic_game_bid_list_by_round(c *gin.Context) {
	...
	if len(p_sort) > 0 {
		var success bool
		sort,success = common.ParseIntFromRemoteOrError(c,HTTP,&p_sort)
		if !success {
			return
		}
	} else {
		common.RespondError(c,"'sort' parameter is not set")
		return
	}
	success,offset,limit := common.ParseOffsetLimitParamsHTML(c)
	if !success {
...
func cosmic_game_bid_info(c *gin.Context) {
	...
	if len(p_evtlog_id) > 0 {
		var success bool
		evtlog_id,success = common.ParseIntFromRemoteOrError(c,HTTP,&p_evtlog_id)
		if !success {
			return
		}
	} else {
		common.RespondError(c,"'evtlog_id' parameter is not set")
		return
	}
...
func cosmic_game_round_info(c *gin.Context) {
	...
	if len(p_prize_num) > 0 {
		var success bool
		prize_num,success = common.ParseIntFromRemoteOrError(c,HTTP,&p_prize_num)
		if !success {
			return
		}
	} else {
		common.RespondError(c,"'prize_num' parameter is not set")
		return
	}
	...
	if !record_found {
		...
		erc20_donations := arb_storagew.Get_erc20_donations_by_round_all(prize_num)
...
func cosmic_game_donations_nft_info(c *gin.Context) {
	...
	if !found {
		common.RespondError(c,"Record not found")
	} else {
...
func cosmic_game_all_eth_deposits_list(c *gin.Context) {
	...
	c.HTML(http.StatusOK, "cg_all_eth_deposits.html", gin.H{
		"AllDeposits" : deposits,
		"Offset" : offset,
		"Limit" : limit,
	})
}
func cosmic_game_raffle_eth_deposits_list(c *gin.Context) {
	...
	c.HTML(http.StatusOK, "cg_raffle_eth_deposits.html", gin.H{
		"RaffleDeposits" : deposits,
		"Offset" : offset,
		"Limit" : limit,
	})
}
func cosmic_game_chronowarrior_eth_deposits_list(c *gin.Context) {
	...
	c.HTML(http.StatusOK, "cg_chronowarrior_eth_deposits.html", gin.H{
...
func cosmic_game_unified_eth_all_by_user(c *gin.Context) {
	...
	c.HTML(http.StatusOK, "cg_user_all_eth_deposits.html", gin.H{
		"UserAddr" : p_user_addr,
		"UserAid" : user_aid,
		"AllDeposits" : deposits,
	})
}
func cosmic_game_unified_eth_raffle_by_user(c *gin.Context) {
	...
	c.HTML(http.StatusOK, "cg_user_raffle_eth_deposits.html", gin.H{
		"UserAddr" : p_user_addr,
		"UserAid" : user_aid,
		"RaffleDeposits" : deposits,
	})
}
func cosmic_game_unified_eth_chronowarrior_by_user(c *gin.Context) {
	...
	c.HTML(http.StatusOK, "cg_user_chronowarrior_eth_deposits.html", gin.H{
		"UserAddr" : p_user_addr,
		"UserAid" : user_aid,
		"ChronoWarriorDeposits" : deposits,
	})
...
func cosmic_game_token_name_search(c *gin.Context) {
	...
	if len(p_name) > 0 {
		...
		common.RespondError(c,"'name' parameter is not set")
		return
	}
...
func cosmic_game_cosmic_token_statistics(c *gin.Context) {
	...
	c.HTML(http.StatusOK, "cg_cosmic_token_statistics.html", gin.H{
...
func cosmic_game_get_eth_price(c *gin.Context) {
	...
	if err != nil {
		...
		if err != nil {
			...
			if err != nil {
				...
				c.HTML(http.StatusOK, "cg_current_eth_price.html", gin.H{
					"ETHPrice": cst_price.String(),
					"SecondsElapsed" : seconds_elapsed.String(),
					"AuctionDuration" : auction_duration.String(),
				})
			}
...
func cosmic_game_admin_events_in_range(c *gin.Context) {
	...
	if len(p_evtlog_start) > 0 {
		var success bool
		evtlog_start,success = common.ParseIntFromRemoteOrError(c,HTTP,&p_evtlog_start)
		if !success {
			return
		}
	} else {
		common.RespondError(c,"'evtlog_start' parameter is not set")
		return
	}
	...
	if len(p_evtlog_end) > 0 {
		var success bool
		evtlog_end,success = common.ParseIntFromRemoteOrError(c,HTTP,&p_evtlog_end)
		if !success {
			return
		}
	} else {
		common.RespondError(c,"'evtlog_end' parameter is not set")
		return
	}
