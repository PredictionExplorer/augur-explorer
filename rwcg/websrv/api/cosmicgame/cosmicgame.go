...
func RegisterHTMLRoutes(r *gin.Engine) {
	...
	r.GET("/black/cosmicgame/donations/nft/by_token/:token_addr", cosmic_game_nft_donations_by_token)
	...
	r.GET("/black/cosmicgame/donations/erc20/by_round/all/:round_num", cosmic_game_donations_erc20_by_round_all)
