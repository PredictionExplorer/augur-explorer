...
import (
	...
	rwcontracts "github.com/PredictionExplorer/augur-explorer/rwcg/contracts/randomwalk"
...
func monitor_events(exit_chan chan bool,addr common.Address) {
	...
	rwalk_aid := storagew.S.Lookup_address_id(addr.String())
...
func main() {
	...
	rwalk_ctrct,err = rwcontracts.NewRWalk(rwalk_addr,eclient)
	if err != nil {
	...
	rwalk_ctrct_aid=storagew.S.Lookup_address_id(rwalk_addr.String())
	market_ctrct_aid=storagew.S.Lookup_address_id(market_addr.String())
