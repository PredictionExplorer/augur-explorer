...
import (
	...
	"github.com/PredictionExplorer/augur-explorer/cmd/srvmonitor/internal/config"
	"github.com/PredictionExplorer/augur-explorer/cmd/srvmonitor/internal/display"
	"github.com/PredictionExplorer/augur-explorer/cmd/srvmonitor/internal/monitor"
...
func main() {
	...
	defer func() { _ = os.Rename(logFilePath, oldLogFilePath) }() // best-effort log rotation on exit
