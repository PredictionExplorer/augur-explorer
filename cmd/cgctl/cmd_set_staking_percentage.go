...
// stakingPercentageSpec drives the set-staking-percentage subcommand.
var stakingPercentageSpec = gameSetterSpec{
...
func init() { register(newGameSetterCmd(stakingPercentageSpec)) }
