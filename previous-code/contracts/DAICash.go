...
// DAICashMetaData contains all meta data concerning the DAICash contract.
var DAICashMetaData = &bind.MetaData{
...
// Deprecated: Use DAICashMetaData.ABI instead.
var DAICashABI = DAICashMetaData.ABI
