...
func parse_integer_param_or_error(c *gin.Context,param_name string,optional,is_json bool) (int64,bool) {
	// assumption: only positive integers are valid
	//	-1 is returned in case tthe parameter is optional (is not present)
