...
func main() {
	...
	if len(os.Args) < 2 {
		fmt.Printf(
			"Usage: \n\t\t%v [private_key]\n\t\t"+
			"Deploys Pinit contract (simple contract to initilize a pool)\n\n",os.Args[0],
		)
		os.Exit(1)
	}
	...
	contract_addr,tx,contract_instance,err := DeployPinit(auth,eclient,common.Address{},common.Address{},common.Address{})
	if err!=nil {
