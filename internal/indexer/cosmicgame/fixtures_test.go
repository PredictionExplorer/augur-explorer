...
func eventFixtures() []fixture {
	...
	return []fixture{
		...
		{name: "admin_charity_percentage", block: 1000, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicCharityPercentageChanged, func(t *testing.T) *types.Log {
			return buildLog(t, gameABI, "CharityEthDonationAmountPercentageChanged", addr(game), nil, []any{bigInt(11)})
		}}}}}},
		{name: "admin_prize_percentage", block: 1010, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicPrizePercentageChanged, func(t *testing.T) *types.Log {
			return buildLog(t, gameABI, "MainEthPrizeAmountPercentageChanged", addr(game), nil, []any{bigInt(26)})
		}}}}}},
		{name: "admin_raffle_percentage", block: 1020, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicRafflePercentageChanged, func(t *testing.T) *types.Log {
			return buildLog(t, gameABI, "RaffleTotalEthPrizeAmountForBiddersPercentageChanged", addr(game), nil, []any{bigInt(6)})
		}}}}}},
		{name: "admin_staking_percentage", block: 1030, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicStakePercentageChanged, func(t *testing.T) *types.Log {
			return buildLog(t, gameABI, "CosmicSignatureNftStakingTotalEthRewardAmountPercentageChanged", addr(game), nil, []any{bigInt(9)})
		}}}}}},
		{name: "admin_chrono_percentage", block: 1040, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicChronoPercentageChanged, func(t *testing.T) *types.Log {
			return buildLog(t, gameABI, "ChronoWarriorEthPrizeAmountPercentageChanged", addr(game), nil, []any{bigInt(8)})
		}}}}}},
		{name: "admin_num_raffle_eth_winners", block: 1050, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicNumRaffleEthPrizeEventsBiddingChanged, func(t *testing.T) *types.Log {
			return buildLog(t, gameABI, "NumRaffleEthPrizesForBiddersChanged", addr(game), nil, []any{bigInt(3)})
		}}}}}},
		{name: "admin_num_raffle_nft_winners", block: 1060, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicNumRaffleNftPrizeEventsBiddingChanged, func(t *testing.T) *types.Log {
			return buildLog(t, gameABI, "NumRaffleCosmicSignatureNftsForBiddersChanged", addr(game), nil, []any{bigInt(5)})
		}}}}}},
		{name: "admin_num_raffle_nft_stakers", block: 1070, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicNumRaffleNftPrizeEventsStakingRwalkChanged, func(t *testing.T) *types.Log {
			return buildLog(t, gameABI, "NumRaffleCosmicSignatureNftsForRandomWalkNftStakersChanged", addr(game), nil, []any{bigInt(4)})
		}}}}}},
		{name: "admin_timeout_claim_prize", block: 1080, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicTimeoutClaimprizeChanged, func(t *testing.T) *types.Log {
			return buildLog(t, gameABI, "TimeoutDurationToClaimMainPrizeChanged", addr(game), nil, []any{bigInt(86400)})
		}}}}}},
		{name: "admin_timeout_withdraw_prizes", block: 1090, txs: []fixtureTx{{to: prizes, logs: []fixtureLog{{TopicTimeoutToWithdrawPrize, func(t *testing.T) *types.Log {
			return buildLog(t, prizesWalletABI, "TimeoutDurationToWithdrawPrizesChanged", addr(prizes), nil, []any{bigInt(600)})
		}}}}}},
		{name: "admin_price_increase_divisor", block: 1100, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicPriceIncreaseChanged, func(t *testing.T) *types.Log {
			return buildLog(t, gameABI, "EthBidPriceIncreaseDivisorChanged", addr(game), nil, []any{bigInt(100)})
		}}}}}},
		{name: "admin_mainprize_time_increment", block: 1110, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicMainPrizeMicrosecondIncrease, func(t *testing.T) *types.Log {
			return buildLog(t, gameABI, "MainPrizeTimeIncrementInMicroSecondsChanged", addr(game), nil, []any{bigInt(3600000000)})
		}}}}}},
		{name: "admin_initial_duration_divisor", block: 1120, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicInitialSecondsUntilPrizeChanged, func(t *testing.T) *types.Log {
			return buildLog(t, gameABI, "InitialDurationUntilMainPrizeDivisorChanged", addr(game), nil, []any{bigInt(2)})
		}}}}}},
		{name: "admin_round_activation_time", block: 1130, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicRoundActivationTimeChanged, func(t *testing.T) *types.Log {
			return buildLog(t, gameABI, "RoundActivationTimeChanged", addr(game), nil, []any{bigInt(1767225600)})
		}}}}}},
		{name: "admin_cst_auction_duration_divisor", block: 1140, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicCstDutchAuctionDurationDivisorChanged, func(t *testing.T) *types.Log {
			return buildLog(t, gameABI, "CstDutchAuctionDurationDivisorChanged", addr(game), nil, []any{bigInt(11)})
		}}}}}},
		{name: "admin_cst_auction_duration_v2", block: 1150, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicCstDutchAuctionDurationChanged, func(t *testing.T) *types.Log {
			return buildLog(t, gameV2ABI, "CstDutchAuctionDurationChanged", addr(game), nil, []any{bigInt(7200)})
		}}}}}},
		{name: "admin_cst_auction_change_divisor_v2", block: 1160, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicCstDutchAuctionDurationChangeDivisorChanged, func(t *testing.T) *types.Log {
			return buildLog(t, gameV2ABI, "CstDutchAuctionDurationChangeDivisorChanged", addr(game), nil, []any{bigInt(3)})
		}}}}}},
		{name: "admin_eth_auction_duration_divisor", block: 1170, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicEthDutchAuctionDurationDivisorChanged, func(t *testing.T) *types.Log {
			return buildLog(t, gameABI, "EthDutchAuctionDurationDivisorChanged", addr(game), nil, []any{bigInt(20)})
		}}}}}},
		{name: "admin_eth_auction_ending_price_divisor", block: 1180, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicEthDutchAuctionEndingPriceDivisorChanged, func(t *testing.T) *types.Log {
			return buildLog(t, gameABI, "EthDutchAuctionEndingBidPriceDivisorChanged", addr(game), nil, []any{bigInt(10)})
		}}}}}},
		{name: "admin_cst_reward_for_bidding", block: 1190, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicCstRewardForBiddingChanged, func(t *testing.T) *types.Log {
			return buildLog(t, gameABI, "CstRewardAmountForBiddingChanged", addr(game), nil, []any{eth(150)})
		}}}}}},
		{name: "admin_bid_cst_reward_raw", block: 1200, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicBidCstRewardAmountChanged, func(t *testing.T) *types.Log {
			return buildRawLog(t, TopicBidCstRewardAmountChanged, addr(game), nil, eth(99))
		}}}}}},
		{name: "admin_bid_cst_reward_multiplier_v2", block: 1210, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicBidCstRewardAmountMultiplierChanged, func(t *testing.T) *types.Log {
			return buildLog(t, gameV2ABI, "BidCstRewardAmountMultiplierChanged", addr(game), nil, []any{bigInt(3)})
		}}}}}},
		{name: "admin_static_cst_reward", block: 1220, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicStaticCstReward, func(t *testing.T) *types.Log {
			return buildLog(t, gameABI, "CstPrizeAmountChanged", addr(game), nil, []any{eth(10)})
		}}}}}},
		{name: "admin_max_message_length", block: 1230, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicMaxMessageLength, func(t *testing.T) *types.Log {
			return buildLog(t, gameABI, "BidMessageLengthMaxLimitChanged", addr(game), nil, []any{bigInt(280)})
		}}}}}},
		{name: "admin_marketing_reward_changed", block: 1240, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicMarketingRewardChanged, func(t *testing.T) *types.Log {
			return buildLog(t, gameABI, "MarketingWalletCstContributionAmountChanged", addr(game), nil, []any{eth(300)})
		}}}}}},
		{name: "admin_delay_duration_round", block: 1250, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicDelayDurationRound, func(t *testing.T) *types.Log {
		...
		{name: "admin_base_uri", block: 1290, txs: []fixtureTx{{to: sig, logs: []fixtureLog{{TopicBaseURI, func(t *testing.T) *types.Log {
		...
		{name: "admin_charity_wallet_changed_game", block: 1300, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicCharityWalletChanged, func(t *testing.T) *types.Log {
			return buildLog(t, gameABI, "CharityAddressChanged", addr(game), []any{addr(fxCharityAddr)}, nil)
		}}}}}},
		{name: "admin_charity_receiver_changed_wallet", block: 1310, txs: []fixtureTx{{to: charity, logs: []fixtureLog{{TopicCharityReceiverChanged, func(t *testing.T) *types.Log {
			return buildLog(t, charityWalletABI, "CharityAddressChanged", addr(charity), []any{addr(fxCharityRcv)}, nil)
		}}}}}},
		{name: "admin_random_walk_address", block: 1320, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicRwalkAddressChanged, func(t *testing.T) *types.Log {
			return buildLog(t, gameABI, "RandomWalkNftAddressChanged", addr(game), []any{addr(fxRandomWalkAddr)}, nil)
		}}}}}},
		{name: "admin_prizes_wallet_address", block: 1330, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicPrizeWalletAddressChanged, func(t *testing.T) *types.Log {
			return buildLog(t, gameABI, "PrizesWalletAddressChanged", addr(game), []any{addr(fxPrizesAddr)}, nil)
		}}}}}},
		{name: "admin_staking_cst_address", block: 1340, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicStakingWalletCstAddressChanged, func(t *testing.T) *types.Log {
			return buildLog(t, gameABI, "StakingWalletCosmicSignatureNftAddressChanged", addr(game), []any{addr(fxStakingCSTAddr)}, nil)
		}}}}}},
		{name: "admin_staking_rwalk_address", block: 1350, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicStakingWalletRwalkAddressChanged, func(t *testing.T) *types.Log {
			return buildLog(t, gameABI, "StakingWalletRandomWalkNftAddressChanged", addr(game), []any{addr(fxStakingRWKAddr)}, nil)
		}}}}}},
		{name: "admin_marketing_address", block: 1360, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicMarketingAddressChanged, func(t *testing.T) *types.Log {
			return buildLog(t, gameABI, "MarketingWalletAddressChanged", addr(game), []any{addr(fxMarketingAddr)}, nil)
		}}}}}},
		{name: "admin_cosmic_token_address", block: 1370, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicCosmicTokenAddressChanged, func(t *testing.T) *types.Log {
			return buildLog(t, gameABI, "CosmicSignatureTokenAddressChanged", addr(game), []any{addr(fxTokenAddr)}, nil)
		}}}}}},
		{name: "admin_cosmic_signature_address", block: 1380, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicCosmicSignatureAddressChanged, func(t *testing.T) *types.Log {
			return buildLog(t, gameABI, "CosmicSignatureNftAddressChanged", addr(game), []any{addr(fxSignatureAddr)}, nil)
		}}}}}},
		{name: "admin_treasurer_changed", block: 1390, txs: []fixtureTx{{to: marketing, logs: []fixtureLog{{TopicTreasurerChanged, func(t *testing.T) *types.Log {
			return buildLog(t, marketingWalletABI, "TreasurerAddressChanged", addr(marketing), []any{addr(fxDave)}, nil)
		}}}}}},
		{name: "admin_proxy_upgraded", block: 1400, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicProxyUpgraded, func(t *testing.T) *types.Log {
			return buildLog(t, gameABI, "Upgraded", addr(game), []any{addr(fxImplAddr)}, nil)
		}}}}}},
		{name: "admin_admin_changed", block: 1410, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicAdminChanged, func(t *testing.T) *types.Log {
			return buildLog(t, erc1967ABI, "AdminChanged", addr(game), nil, []any{addr(fxAlice), addr(fxBob)})
		}}}}}},
		{name: "admin_ownership_transferred", block: 1420, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicOwnershipTransferred, func(t *testing.T) *types.Log {
			return buildLog(t, gameABI, "OwnershipTransferred", addr(game), []any{addr(fxAlice), addr(fxBob)}, nil)
		}}}}}},
		{name: "admin_initialized", block: 1430, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicInitialized, func(t *testing.T) *types.Log {
			return buildLog(t, gameABI, "Initialized", addr(game), nil, []any{uint64(1)})
		}}}}}},
		{name: "admin_fund_transfer_failed", block: 1440, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicFundTransferErr, func(t *testing.T) *types.Log {
		...
		{name: "bid_cst_v1", block: 1470, txs: []fixtureTx{{to: game, logs: []fixtureLog{
			{TopicTransferEvt, func(t *testing.T) *types.Log { // burn of the paid CST price (ignored by the reward matcher)
			...
			{TopicTransferEvt, func(t *testing.T) *types.Log { // reward mint to the bidder
		...
		// --- Donations ---
		{name: "donation_eth", block: 1510, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicEthDonatedEvent, func(t *testing.T) *types.Log {
			return buildLog(t, gameABI, "EthDonated", addr(game), []any{bigInt(0), addr(fxDave)}, []any{eth(2)})
		}}}}}},
		{name: "donation_eth_with_info", block: 1520, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicEthDonatedWIEvent, func(t *testing.T) *types.Log {
			return buildLog(t, gameABI, "EthDonatedWithInfo", addr(game), []any{bigInt(0), addr(fxEmma), bigInt(1)}, []any{eth(3)})
		}}}}}},
		{name: "donation_received_standalone", block: 1530, txs: []fixtureTx{{to: charity, logs: []fixtureLog{{TopicDonationReceivedEvent, func(t *testing.T) *types.Log {
		...
		{name: "donation_erc20_without_bid", block: 1570, txs: []fixtureTx{{to: prizes, logs: []fixtureLog{{TopicERC20Donated, func(t *testing.T) *types.Log {
			return buildLog(t, prizesWalletABI, "TokenDonated", addr(prizes),
				[]any{bigInt(0), addr(fxBob), addr(fxMockERC20)}, []any{eth(25)})
		}}}}}},
		{name: "donation_nft", block: 1580, txs: []fixtureTx{{to: prizes, logs: []fixtureLog{{TopicNftEthDonatedEvent, func(t *testing.T) *types.Log {
			return buildLog(t, prizesWalletABI, "NftDonated", addr(prizes),
				[]any{bigInt(0), addr(fxBob), addr(fxDonatedNFT)}, []any{bigInt(5), bigInt(0)})
		}}}}}},
		{name: "donated_token_claimed", block: 1590, txs: []fixtureTx{{to: prizes, logs: []fixtureLog{{TopicDonatedTokenClaimed, func(t *testing.T) *types.Log {
			return buildLog(t, prizesWalletABI, "DonatedTokenClaimed", addr(prizes),
				[]any{bigInt(0), addr(fxAlice), addr(fxMockERC20)}, []any{eth(50)})
		}}}}}},
		{name: "donated_nft_claimed", block: 1600, txs: []fixtureTx{{to: prizes, logs: []fixtureLog{{TopicDonatedNftClaimed, func(t *testing.T) *types.Log {
		...
		{name: "prizes_eth_deposit", block: 1620, txs: []fixtureTx{{to: prizes, logs: []fixtureLog{{TopicEthPrizeDepositEvent, func(t *testing.T) *types.Log {
		...
		{name: "prizes_eth_withdrawal", block: 1630, txs: []fixtureTx{
			{blockOffset: 0, to: prizes, logs: []fixtureLog{{TopicEthPrizeDepositEvent, func(t *testing.T) *types.Log {
				return buildLog(t, prizesWalletABI, "EthReceived", addr(prizes),
					[]any{bigInt(0), addr(fxBob)}, []any{bigInt(2), eth(1)})
			}}}},
			{blockOffset: 1, to: prizes, logs: []fixtureLog{{TopicEthPrizeWithdrawalEvent, func(t *testing.T) *types.Log {
				return buildLog(t, prizesWalletABI, "EthWithdrawn", addr(prizes),
					[]any{bigInt(0), addr(fxBob), addr(fxBob)}, []any{eth(1)})
			}}}},
		}},
		{name: "raffle_eth_winner", block: 1640, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicRaffleEthPrizeEvent, func(t *testing.T) *types.Log {
			return buildLog(t, gameABI, "RaffleWinnerBidderEthPrizeAllocated", addr(game),
				[]any{bigInt(0), addr(fxBob)}, []any{bigInt(0), eth(1)})
		}}}}}},
		{name: "raffle_nft_winner_bidder", block: 1650, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicRaffleNftPrizeEvent, func(t *testing.T) *types.Log {
			return buildLog(t, gameABI, "RaffleWinnerPrizePaid", addr(game),
				[]any{bigInt(0), addr(fxDave), bigInt(2)}, []any{false, bigInt(1), eth(5)})
		}}}}}},
		{name: "raffle_nft_winner_staker", block: 1660, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicRaffleNftPrizeEvent, func(t *testing.T) *types.Log {
			return buildLog(t, gameABI, "RaffleWinnerPrizePaid", addr(game),
				[]any{bigInt(0), addr(fxCarol), bigInt(3)}, []any{true, bigInt(0), eth(5)})
		}}}}}},
		{name: "endurance_champion_prize", block: 1670, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicEndurancePrizeEvent, func(t *testing.T) *types.Log {
			return buildLog(t, gameABI, "EnduranceChampionPrizePaid", addr(game),
				[]any{bigInt(0), addr(fxBob), bigInt(4)}, []any{eth(7)})
		}}}}}},
		{name: "last_cst_bidder_prize", block: 1680, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicLastcstBidderPrizeEvent, func(t *testing.T) *types.Log {
			return buildLog(t, gameABI, "LastCstBidderPrizePaid", addr(game),
				[]any{bigInt(0), addr(fxCarol), bigInt(5)}, []any{eth(6)})
		}}}}}},
		{name: "chrono_warrior_prize", block: 1690, txs: []fixtureTx{{to: game, logs: []fixtureLog{{TopicChronoWarriorPrizeEvent, func(t *testing.T) *types.Log {
			return buildLog(t, gameABI, "ChronoWarriorPrizePaid", addr(game),
				[]any{bigInt(0), addr(fxAlice), bigInt(6)}, []any{bigInt(0), eth(2), eth(8)})
		}}}}}},

		// --- Tokens ---
		{name: "token_mint", block: 1700, txs: []fixtureTx{{to: sig, logs: []fixtureLog{{TopicMintEvent, func(t *testing.T) *types.Log {
		...
		{name: "token_name_after_mint", block: 1710, txs: []fixtureTx{
			{blockOffset: 0, to: sig, logs: []fixtureLog{{TopicMintEvent, func(t *testing.T) *types.Log {
				return buildLog(t, signatureABI, "NftMinted", addr(sig),
					[]any{bigInt(0), addr(fxAlice), bigInt(1)}, []any{bigInt(0xbeef)})
			}}}},
			{blockOffset: 1, to: sig, logs: []fixtureLog{{TopicTokenNameEvent, func(t *testing.T) *types.Log {
				return buildLog(t, signatureABI, "NftNameChanged", addr(sig),
					[]any{bigInt(1)}, []any{"Genesis Fixture"})
			}}}},
		}},
		{name: "token_transfer_erc721", block: 1720, txs: []fixtureTx{{to: sig, logs: []fixtureLog{{TopicTransferEvt, func(t *testing.T) *types.Log {
			return buildLog(t, erc721ABI, "Transfer", addr(sig),
				[]any{addr(fxAlice), addr(fxBob), bigInt(1)}, nil)
		}}}}}},
		{name: "token_transfer_erc20", block: 1730, txs: []fixtureTx{{to: token, logs: []fixtureLog{{TopicTransferEvt, func(t *testing.T) *types.Log {
			return buildLog(t, erc20ABI, "Transfer", addr(token),
				[]any{addr(fxAlice), addr(fxBob)}, []any{eth(25)})
		}}}}}},
		{name: "marketing_reward_paid", block: 1740, txs: []fixtureTx{{to: marketing, logs: []fixtureLog{{TopicMarketingRewardPaid, func(t *testing.T) *types.Log {
			return buildLog(t, marketingWalletABI, "RewardPaid", addr(marketing),
				[]any{addr(fxEmma)}, []any{eth(12)})
		}}}}}},

		// --- Staking ---
		{name: "staking_cst_stake", block: 1750, txs: []fixtureTx{{to: stakeCST, logs: []fixtureLog{{TopicCstNftStakedEvent, func(t *testing.T) *types.Log {
		...
		{name: "staking_cst_stake_unstake", block: 1760, txs: []fixtureTx{
			{blockOffset: 0, to: stakeCST, logs: []fixtureLog{{TopicCstNftStakedEvent, func(t *testing.T) *types.Log {
				return buildLog(t, stakingCSTABI, "NftStaked", addr(stakeCST),
					[]any{bigInt(1), bigInt(1), addr(fxAlice)}, []any{bigInt(1), bigInt(0)})
			}}}},
			{blockOffset: 1, to: stakeCST, logs: []fixtureLog{{TopicNftUnstakedCst, func(t *testing.T) *types.Log {
		...
		{name: "staking_rwalk_stake", block: 1770, txs: []fixtureTx{{to: stakeRWK, logs: []fixtureLog{{TopicRwalkNftStakedEvent, func(t *testing.T) *types.Log {
		...
		{name: "staking_rwalk_stake_unstake", block: 1780, txs: []fixtureTx{
			{blockOffset: 0, to: stakeRWK, logs: []fixtureLog{{TopicRwalkNftStakedEvent, func(t *testing.T) *types.Log {
				return buildLog(t, stakingRWalkABI, "NftStaked", addr(stakeRWK),
					[]any{bigInt(5), bigInt(10), addr(fxCarol)}, []any{bigInt(1)})
			}}}},
			{blockOffset: 1, to: stakeRWK, logs: []fixtureLog{{TopicNftUnstakedRwalk, func(t *testing.T) *types.Log {
		...
		{name: "staking_eth_deposit", block: 1790, txs: []fixtureTx{
			...
			{blockOffset: 1, to: stakeCST, logs: []fixtureLog{{TopicStakingEthDepositEvent, func(t *testing.T) *types.Log {
...
func buildERC20TransferFailedLog(t *testing.T, contract, destination ethcommon.Address, errStr string, amount *big.Int) *types.Log {
	...
	return &types.Log{
		...
		Topics: []ethcommon.Hash{
			ethcommon.HexToHash("0x" + TopicERC20TransferErr),
