...
func TestMapRoundOmitsSentinelsAndLegacyCollections(t *testing.T) {
	...
	record.CharityDeposit = cgprimitives.CGCharityDeposit{}
	record.StakingDeposit.StakingDepositId = -1
	record.EnduranceChampion = cgprimitives.CGEnduranceChampionPrize{}
	record.LastCstBidder = cgprimitives.CGLastCSTBidderPrize{}
	record.ChronoWarrior = cgprimitives.CGChronoWarriorPrize{}
	...
	record.RaffleNFTWinners = []cgprimitives.CGRaffleNFTWinnerRec{{TokenId: 1}}
	record.AllPrizes = []cgprimitives.CGPrizeHistory{{RecordType: 1}}
...
func TestMapRoundRejectsInvalidStoreData(t *testing.T) {
	...
	tests := map[string]func(*cgprimitives.CGRoundRec){
		"round overflow":       func(r *cgprimitives.CGRoundRec) { r.RoundNum = math.MaxUint64 },
		"claim identity":       func(r *cgprimitives.CGRoundRec) { r.ClaimPrizeTx.Tx.EvtLogId = 0 },
		"claim hash":           func(r *cgprimitives.CGRoundRec) { r.ClaimPrizeTx.Tx.TxHash = "bad" },
		"claim timestamp":      func(r *cgprimitives.CGRoundRec) { r.ClaimPrizeTx.Tx.DateTime = "bad" },
		"winner address":       func(r *cgprimitives.CGRoundRec) { r.MainPrize.WinnerAddr = "bad" },
		"main eth amount":      func(r *cgprimitives.CGRoundRec) { r.MainPrize.EthAmount = "-1" },
		"main cst amount":      func(r *cgprimitives.CGRoundRec) { r.MainPrize.CstAmount = "wat" },
		"main token overflow":  func(r *cgprimitives.CGRoundRec) { r.MainPrize.NftTokenId = math.MaxUint64 },
		"main deadline":        func(r *cgprimitives.CGRoundRec) { r.MainPrize.TimeoutTs = -1 },
		"negative aggregate":   func(r *cgprimitives.CGRoundRec) { r.RoundStats.TotalBids = -1 },
		"raffle amount":        func(r *cgprimitives.CGRoundRec) { r.RoundStats.TotalRaffleEthDeposits = "1.2" },
		"donation amount":      func(r *cgprimitives.CGRoundRec) { r.RoundStats.TotalDonatedAmount = "-1" },
		"timing timestamp":     func(r *cgprimitives.CGRoundRec) { r.RoundStats.RoundStartTime = "bad" },
		"timing duration":      func(r *cgprimitives.CGRoundRec) { r.RoundStats.RoundDurationSeconds = -1 },
		"charity address":      func(r *cgprimitives.CGRoundRec) { r.CharityDeposit.CharityAddress = "bad" },
		"staking identity":     func(r *cgprimitives.CGRoundRec) { r.StakingDeposit.StakingDepositId = -2 },
		"staking amount":       func(r *cgprimitives.CGRoundRec) { r.StakingDeposit.StakingDepositAmount = "" },
		"endurance address":    func(r *cgprimitives.CGRoundRec) { r.EnduranceChampion.WinnerAddr = "bad" },
		"last cst amount":      func(r *cgprimitives.CGRoundRec) { r.LastCstBidder.CstAmount = "" },
		"chrono token":         func(r *cgprimitives.CGRoundRec) { r.ChronoWarrior.NftTokenId = -1 },
		"chrono eth amount":    func(r *cgprimitives.CGRoundRec) { r.ChronoWarrior.EthAmount = "wat" },
		"activation timestamp": func(r *cgprimitives.CGRoundRec) { r.RoundStats.ActivationTime = -1 },
	}
...
func TestMapCharityAllocationSplitsAddresses(t *testing.T) {
	...
	allocation, err := mapCharityAllocation(cgprimitives.CGCharityDeposit{
