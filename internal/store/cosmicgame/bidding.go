...
// buildBidSelectQuery is the legacy (database/sql) twin of bidSelectQuery;
// it remains only for Get_bids_by_user in user-specific.go and is deleted
// when that file converts to the Repo.
...
// scanBidRecord is the legacy twin of scanBidRow; it remains only for
