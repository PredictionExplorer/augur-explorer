...
const (
	...
	COINTYPE_BITCOIN          int = 0
	COINTYPE_LITECOIN         int = 2
	COINTYPE_DOGECOIN         int = 3
	COINTYPE_MONACOIN         int = 22
	COINTYPE_ETHEREUM_CLASSIC int = 61
	COINTYPE_ROOTSTOCK        int = 137
	COINTYPE_RIPPLE           int = 144
	COINTYPE_BITCOIN_CASH     int = 145
	COINTYPE_BINANCE          int = 714
)
const (
	OOOpCodeNone = iota
	OOOpCodeCreated
