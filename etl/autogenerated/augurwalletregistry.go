...
// AugurWalletFactory is a free data retrieval call binding the contract method 0x9ac03fd0.
//
// Solidity: function augurWalletFactory() view returns(address)
func (_AugurWalletRegistry *AugurWalletRegistryCaller) AugurWalletFactory(opts *bind.CallOpts) (common.Address, error) {
	var (
		ret0 = new(common.Address)
	)
	out := ret0
	err := _AugurWalletRegistry.contract.Call(opts, out, "augurWalletFactory")
	return *ret0, err
}
...
//
// Solidity: function augurWalletFactory() view returns(address)
func (_AugurWalletRegistry *AugurWalletRegistrySession) AugurWalletFactory() (common.Address, error) {
	return _AugurWalletRegistry.Contract.AugurWalletFactory(&_AugurWalletRegistry.CallOpts)
}

// AugurWalletFactory is a free data retrieval call binding the contract method 0x9ac03fd0.
//
// Solidity: function augurWalletFactory() view returns(address)
func (_AugurWalletRegistry *AugurWalletRegistryCallerSession) AugurWalletFactory() (common.Address, error) {
	return _AugurWalletRegistry.Contract.AugurWalletFactory(&_AugurWalletRegistry.CallOpts)
}
