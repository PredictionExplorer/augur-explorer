...
//
// Solidity: function getMarketCreationData(address _market) view returns(IAugurCreationDataGetterMarketCreationData)
func (_Augur *AugurCaller) GetMarketCreationData(opts *bind.CallOpts, _market common.Address) (IAugurCreationDataGetterMarketCreationData, error) {
	var (
		ret0 = new(IAugurCreationDataGetterMarketCreationData)
	)
	out := ret0
